# webOS Home Screen Project

> LG 서강대학교 캡스톤 프로젝트 - webOS의 첫 화면을 디자인하라
...
**Frontend**: Flutter (webOS) | **Backend**: Express (TypeScript) | **DB**: PostgreSQL | **AI**: TensorFlow.js

## 📞 연락처

- **Discord**: 팀 회의 및 일상 소통
